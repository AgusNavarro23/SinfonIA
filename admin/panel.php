...
<html lang="en">
  ...
  <head>
    ...
    <title>SINFONIA | Dashboard</title>
    ...
    <div class="app-wrapper">
            ...
            <li class="nav-item dropdown user-menu">
              ...
              <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                ...
                <li class="user-footer">
                  ...
                  <a href="panel.php?modulo=&sesion=cerrar" class="btn btn-danger float-end">Cerrar Sesión</a>
                </li>
                <!--end::Menu Footer-->
              </ul>
            </li>
      ...
      <aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark">
        ...
        <div class="sidebar-brand">
          ...
          <a href="panel.php" class="brand-link">
            <!--begin::Brand Image-->
            <img
              src="dist/assets/img/logo_sinfonia.png"
              alt="AdminLTE Logo"
              class="brand-image opacity-75 shadow"
            />
            <!--end::Brand Image-->
            <!--begin::Brand Text-->
            <span class="brand-text fw-light">SINFONIA</span>
            <!--end::Brand Text-->
          </a>
          <!--end::Brand Link-->
        </div>
      ...
      <?php
        if($modulo=="estadisticas"){
          include_once "pages/estadisticas.php";
          }
        if($modulo=="productos"){
      ...
      <footer class="app-footer">
        ...
        <strong>
          ...
          <a href="https://adminlte.io" class="text-decoration-none">SINFONIA</a>.
        </strong>
